...
createViz("assets/data/wc_char_tri.csv");

function changeViz() {
  var file = "assets/data/" + document.getElementById("movie").value + ".csv";
...
createGenderViz("assets/data/wc_gender_tri.csv");

function changeViz() {
  var char_file = "assets/data/wc_char_" + document.getElementById("movie").value + ".csv";
  var gender_file = "assets/data/wc_gender_" + document.getElementById("movie").value + ".csv";
  d3.select(".char").selectAll("*").remove();
